...
public class PutData {
    ...
    private final LinkUrl url = new LinkUrl("https://demoqa.com/automation-practice-form",
            "Practice Form");
    ...
    private final Buttons genderButton = new Buttons("Выбор пола",
            $$(".custom-control-label").get(1));
    ...
    private final SelectorWAuto subjects = new SelectorWAuto("Предметы",
            $("#subjectsInput"));
    private final Buttons hobbies = new Buttons("Хобби",
    ...
    private final DropDown state = new DropDown("Штат", $("#state"),
            $("#stateCity-wrapper"));
    private final DropDown city = new DropDown("Город", $("#city"),
            $("#stateCity-wrapper"));
